...
#Order
Order.find_or_create_by(investable_id:Individual.find_by_id_no('310103197506170445').id,user_id:User.find_by_name('孙萍').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:119993.50,due_date:'2015/11/26',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('33260319730927001X').id,user_id:User.find_by_name('车丽娜').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:119993.50,due_date:'2015/11/26',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('33260319730927001X').id,user_id:User.find_by_name('车丽娜').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:119993.50,due_date:'2015/11/27',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('310103197506170445').id,user_id:User.find_by_name('孙萍').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:39993.50,due_date:'2015/11/27',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('33260319730927001X').id,user_id:User.find_by_name('车丽娜').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:119993.50,due_date:'2015/11/30',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('33260319730927001X').id,user_id:User.find_by_name('车丽娜').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:119993.50,due_date:'2015/11/30',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('110101197202261516').id,user_id:User.find_by_name('周建敏').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:159993.50,due_date:'2015/11/30',state:'已起息',booking_date:'2015/11/30',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('31011019650206461X').id,user_id:User.find_by_name('孙萍').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:179993.50,due_date:'2015/11/30',state:'已起息',booking_date:'2015/11/30',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('340406196211093223').id,user_id:User.find_by_name('冯鑫').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:299993.50,due_date:'2015/11/30',state:'已起息',booking_date:'2015/11/30',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('310104198209246811').id,user_id:User.find_by_name('解杰竣').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:200000.00,due_date:'2015/11/30',state:'已起息',booking_date:'2015/11/30',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('33260319730927001X').id,user_id:User.find_by_name('车丽娜').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:119993.50,due_date:'2015/12/1',state:'已起息',booking_date:'2015/11/26',investable_type:'User').save!(validate:false)
Order.find_or_create_by(investable_id:Individual.find_by_id_no('620102196512095324').id,user_id:User.find_by_name('王彦洁').id,product_id:Product.find_by_name('禾晖*稳健量化1号基金第一期').id,amount:149993.50,due_date:'2015/12/1',state:'已起息',booking_date:'2015/12/1',investable_type:'User').save!(validate:false)
